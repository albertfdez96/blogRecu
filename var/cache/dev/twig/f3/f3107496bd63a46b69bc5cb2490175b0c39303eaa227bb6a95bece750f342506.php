...
class __TwigTemplate_f350f3de1bf14acc1bcb0da0b502ef1816bd688184e00eb3528bfec316479fc7 extends \Twig\Template
{
    private $source;
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    ";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\DumpExtension']->dump($this->env, $context, (isset($context["posts"]) || array_key_exists("posts", $context) ? $context["posts"] : (function () { throw new RuntimeError('Variable "posts" does not exist.', 6, $this->source); })()));
        echo "
    ";
        // line 7
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
            ...
            <div><h3>";
            // line 10
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "content", []), "html", null, true);
            echo "</h3></div>
            <div><b>";
            // line 11
    ...
    {
        return array (  104 => 11,  100 => 10,  96 => 9,  93 => 8,  89 => 7,  84 => 6,  75 => 5,  57 => 3,  27 => 1,);
    }
...
{% block body %}
    ...
    {% endfor %}
{% endblock %}
", "post/index.html.twig", "/home/linux/www/projects/blog/templates/post/index.html.twig");
    }
}
